...
void GPIO_EVEN_IRQHandler(void) {// BTN1 is connected to pin10 -> even irs
    turn_right = true;
    // Clear the interrupt flag for BUTTON1
    GPIO_IntClear(0x0000FFFF);
}


void GPIO_ODD_IRQHandler(void) {   //BTN0 is connected to pin9 -> odd irs
    turn_left = true;
